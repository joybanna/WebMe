...
function profile_experiece_part() {
  ...
  const listExp = data.map((data) =>
    <div class="w3-row">
      <div class="w3-col s6 w3-margin-bottom w3-margin-top w3-left-align"><a class="sub-text">{data.date}</a></div>
      <div class="w3-col s6 w3-margin-bottom w3-margin-top">
        <a class="sub-text-title"><b>{data.title}</b> </a>
        <div className='w3-margin-bottom w3-margin-top'><a class="sub-text-title-a ">{data.position}</a></div>
        <a className='sub-text'> <ul>
