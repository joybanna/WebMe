...
function DataProject(isPersonal) {
    const monopoly = {
        ...
        hf: "/WebMe/projects/Monopoly Prototype",
        list: ["Multiplayer game", "Multiplayer systems powered by Photon Network", "Turnbase game", "Many characters", "Semi rogelike style"],
    ...
    const stealth = {
        ...
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/Stealth Prototype",
        list: ["Stealth game", "Challenge to play", "Simple to play", "Short game"],
    ...
    const help = {
        project: "Help Me plz !!!!",
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/Help Me plz !!!!",
        list: ["2D Shooting Side Scroll game", "Challenge to play", "Simple to play"],
    ...
    const typingTyohoon = {
        ...
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/Typing Typhoon (NSC)",
    ...
    const desir = {
        ...
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/De'sir The fragment of Memory (Thesis)",
        list: ["2D Semi idle Heroes collection Game", "PC and Mobile platforms", "Many systems"],
    ...
    const theLost = {
        ...
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/The Lost Treasure",
        list: ["3D plazzle platform Game", "Third-person camera", "Interactive NPC", "Enemy use navmesh agent"],
    ...
    const skyShooter = {
        ...
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/Sky Shooting",
        list: ["3D Shooting Game", "Mobile platforms", "AR system powered by Vuforia"],
    ...
    const findMe = {
        project: "Find Me",
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/Find Me",
        list: ["3D Hide and Seek Game", "Multiplayer systems powered by Unet", "Third-person shooting", "Side arm camera"],
    ...
    const towerDefence = {
        ...
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/Kingdom castle",
        list: ["2D Tower Defence game", "...", "...", "..."],
    ...
    const popit = {
        project: "Popit",
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/Popit",
        list: ["3D Popit simulation game", "...", "..."],
    ...
    const superslime = {
        project: "Super Slime",
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/Super Slime",
        list: ["3D slime simulation game", "...", "..."],
    ...
    const monsterdraft = {
        ...
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/Monster Draft",
        list: ["3D running game", "...", "..."],
    ...
    const savethedog = {
        ...
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/Save The Dog",
        list: ["2D puzzle game", "...", "..."],
    ...
    const watersort = {
        project: "Water Sort",
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/Water Sort",
        list: ["2D sorting puzzle game", "...", "..."],
    ...
    const hairsalon = {
        project: "Hair Salon",
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/Hair Salon",
        list: ["3D hair salon simulation game", "...", "..."],
    ...
    const parkescape = {
        project: "Park Escape",
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/Park Escape",
        list: ["3D escape puzzle game", "...", "..."],
    ...
    const findit = {
        project: "Find It",
        thumnil: "https://loremflickr.com/200/200?random=1",
        hf: "/WebMe/projects/Find It",
        list: ["2D find the objects in game", "...", "..."],
    ...
    const companyList = [towerDefence, popit, stealGame, drawpuzzle, pathpuzzle, superslime, monsterdraft, mergehero, savethedog, watersort, hairsalon, parkescape, findit]
