...
function ProjectsDetail() {
    const monopoly = {
        ...
        imgs: [
            "src/assets/img/pic_pro_1/mono_01.png",
            "src/assets/img/pic_pro_1/mono_02.png",
            "src/assets/img/pic_pro_1/mono_03.png",
            "src/assets/img/pic_pro_1/mono_04.png",
            "src/assets/img/pic_pro_1/mono_05.png",
            "src/assets/img/pic_pro_1/mono_06.png",
            "src/assets/img/pic_pro_1/mono_07.png",
        ],
    ...
    const stealth = {
        ...
        imgs: [
            "src/assets/img/pic_pro_2/stealth_01.PNG",
            "src/assets/img/pic_pro_2/stealth_02.PNG",
            "src/assets/img/pic_pro_2/stealth_03.PNG",
            "src/assets/img/pic_pro_2/stealth_04.PNG",
            "src/assets/img/pic_pro_2/stealth_05.PNG",
        ],
    ...
    const help = {
        ...
        project: "Help Me plz !!!!",
        imgs: [
            "src/assets/img/pic_pro_3/help_01.PNG",
            "src/assets/img/pic_pro_3/help_02.PNG",
            "src/assets/img/pic_pro_3/help_03.PNG",
            "src/assets/img/pic_pro_3/help_04.PNG",
            "src/assets/img/pic_pro_3/help_05.PNG",
            "src/assets/img/pic_pro_3/help_06.PNG",
        ],
    ...
    const typingTyohoon = {
        ...
        imgs: [
            "src/assets/img/pic_pro_4/typing_01.PNG",
            "src/assets/img/pic_pro_4/typing_02.PNG",
            "src/assets/img/pic_pro_4/typing_03.PNG",
            "src/assets/img/pic_pro_4/typing_04.PNG",
            "src/assets/img/pic_pro_4/typing_05.PNG",
            "src/assets/img/pic_pro_4/typing_06.PNG",
            "src/assets/img/pic_pro_4/typing_07.PNG",
            "src/assets/img/pic_pro_4/typing_08.PNG",
            "src/assets/img/pic_pro_4/typing_09.PNG",
        ],
        reference: "",
        video: "",
    ...
    const desir = {
        ...
        imgs: [
            "src/assets/img/pic_pro_5/de_01.PNG",
            "src/assets/img/pic_pro_5/de_02.PNG",
            "src/assets/img/pic_pro_5/de_03.PNG",
            "src/assets/img/pic_pro_5/de_04.PNG",
            "src/assets/img/pic_pro_5/de_05.PNG",
            "src/assets/img/pic_pro_5/de_06.PNG",
            "src/assets/img/pic_pro_5/de_07.PNG",
            "src/assets/img/pic_pro_5/de_08.PNG",
            "src/assets/img/pic_pro_5/de_09.PNG",
            "src/assets/img/pic_pro_5/de_10.PNG",
            "src/assets/img/pic_pro_5/de_11.PNG",
            "src/assets/img/pic_pro_5/de_12.PNG",
            "src/assets/img/pic_pro_5/de_13.PNG",
            "src/assets/img/pic_pro_5/de_14.PNG",
            "src/assets/img/pic_pro_5/de_15.PNG",
            "src/assets/img/pic_pro_5/de_16.PNG",
            "src/assets/img/pic_pro_5/de_17.PNG",
            "src/assets/img/pic_pro_5/de_18.PNG",
        ],
        reference: "",
    ...
    const theLost = {
        ...
        imgs: [
            "src/assets/img/pic_pro_6/the_01.PNG",
            "src/assets/img/pic_pro_6/the_02.PNG",
            "src/assets/img/pic_pro_6/the_03.PNG",
            "src/assets/img/pic_pro_6/the_04.PNG",
        ],
    ...
    const skyShooter = {
        ...
        imgs: [
            "src/assets/img/pic_pro_7/sky_01.PNG",
            "src/assets/img/pic_pro_7/sky_02.PNG",
            "src/assets/img/pic_pro_7/sky_03.PNG",
            "src/assets/img/pic_pro_7/sky_04.PNG",
            "src/assets/img/pic_pro_7/sky_05.PNG",
            "src/assets/img/pic_pro_7/sky_06.PNG",
        ],
    ...
    const findMe = {
        ...
        project: "Find Me",
        imgs: [
            "src/assets/img/pic_pro_8/find_01.PNG",
            "src/assets/img/pic_pro_8/find_02.PNG",
            "src/assets/img/pic_pro_8/find_03.PNG",
            "src/assets/img/pic_pro_8/find_04.PNG",
            "src/assets/img/pic_pro_8/find_05.PNG",
            "src/assets/img/pic_pro_8/find_06.PNG",
            "src/assets/img/pic_pro_8/find_07.PNG",
            "src/assets/img/pic_pro_8/find_08.PNG",
    ...
    const towerDefence = {
        ...
        imgs: [
            "src/assets/img/KindomCastle/KC_001.png",
            "src/assets/img/KindomCastle/KC_002.png",
            "src/assets/img/KindomCastle/KC_003.png",
            "src/assets/img/KindomCastle/KC_004.png",
        ],
    ...
    const popit = {
        ...
        project: "Popit",
        imgs: [
            "src/assets/img/PopIt/PI_001.png",
            "src/assets/img/PopIt/PI_002.png",
            "src/assets/img/PopIt/PI_003.png",
            "src/assets/img/PopIt/PI_004.png",
            "src/assets/img/PopIt/PI_005.png",
        ],
    ...
    const stealGame = {
        ...
        project: "Steal Game",
        imgs: [
            "src/assets/img/StealGame/SG_001.png",
            "src/assets/img/StealGame/SG_002.png",
            "src/assets/img/StealGame/SG_003.png",
            "src/assets/img/StealGame/SG_004.png",
        ],
    ...
    const drawpuzzle = {
        ...
        project: "Draw Puzzle",
        imgs: [
            "src/assets/img/DrawPuzzle/DP_001.png",
            "src/assets/img/DrawPuzzle/DP_002.png",
            "src/assets/img/DrawPuzzle/DP_003.png",
            "src/assets/img/DrawPuzzle/DP_004.png",
        ],
    ...
    const pathpuzzle = {
        ...
        project: "Path Puzzle",
        imgs: [
            "src/assets/img/PathPuzzle/PP_001.png",
            "src/assets/img/PathPuzzle/PP_002.png",
            "src/assets/img/PathPuzzle/PP_003.png",
            "src/assets/img/PathPuzzle/PP_004.png",
        ],
    ...
    const superslime = {
        ...
        project: "Super Slime",
        imgs: [
            "src/assets/img/Slime/S_001.png",
            "src/assets/img/Slime/S_002.png",
            "src/assets/img/Slime/S_003.png",
            "src/assets/img/Slime/S_004.png",
        ],
    ...
    const monsterdraft = {
        ...
        imgs: [
            "src/assets/img/MonsterDraft/MD_001.png",
            "src/assets/img/MonsterDraft/MD_002.png",
            "src/assets/img/MonsterDraft/MD_003.png",
            "src/assets/img/MonsterDraft/MD_004.png",
        ],
    ...
    const mergehero = {
        ...
        project: "Merge Hero",
        imgs: [
            "src/assets/img/MergeHero/MH_001.png",
            "src/assets/img/MergeHero/MH_002.png",
            "src/assets/img/MergeHero/MH_003.png",
            "src/assets/img/MergeHero/MH_004.png",
        ],
    ...
    const savethedog = {
        ...
        imgs: [
            "src/assets/img/SaveTheDog/STD_001.png",
            "src/assets/img/SaveTheDog/STD_002.png",
            "src/assets/img/SaveTheDog/STD_003.png",
            "src/assets/img/SaveTheDog/STD_004.png",
            "src/assets/img/SaveTheDog/STD_005.png",
        ],
    ...
    const watersort = {
        ...
        project: "Water Sort",
        imgs: [
            "src/assets/img/WaterSort/WS_001.png",
            "src/assets/img/WaterSort/WS_002.png",
            "src/assets/img/WaterSort/WS_003.png",
            "src/assets/img/WaterSort/WS_004.png",
        ],
    ...
    const hairsalon = {
        ...
        project: "Hair Salon",
        imgs: [
            "src/assets/img/HairSalon/HS_002.png",
            "src/assets/img/HairSalon/HS_003.png",
            "src/assets/img/HairSalon/HS_004.png",
            "src/assets/img/HairSalon/HS_005.png",
        ],
    ...
    const parkescape = {
        ...
        project: "Park Escape",
        imgs: [
            "src/assets/img/ParkEscape/PE_001.png",
            "src/assets/img/ParkEscape/PE_002.png",
            "src/assets/img/ParkEscape/PE_003.png",
            "src/assets/img/ParkEscape/PE_004.png",
        ],
        reference: "",
        video: "",
    ...
    const findit = {
        ...
        project: "Find It",
        imgs: [
            "src/assets/img/FindIt/FI_001.png",
            "src/assets/img/FindIt/FI_002.png",
            "src/assets/img/FindIt/FI_003.png",
            "src/assets/img/FindIt/FI_004.png",
        ],
